                ...
                <div className="contact">
                    ...
                    <ul>
                        <li><label>Email</label>
                            <textarea defaultValue={userData["email"] == null ? '' : userData["email"]} 
                        ...
                        <li><label>Twitter username</label>
                            <textarea defaultValue={userData["twitter_username"] == null ? '' : userData["twitter_username"]} 
                                onChange={e => this.handleChange("twitter_username", e)} 
                                spellCheck="false"></textarea></li>
                        <li><label>LinkedIn</label>
                            <textarea defaultValue={userData["linkedin_url"] == null ? '' : userData["linkedin_url"]} 
